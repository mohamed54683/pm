...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Sprints",
    subItems: [
      { name: "Active Sprints", path: "/sprints" },
      { name: "Backlog", path: "/sprints/backlog" },
      { name: "Releases", path: "/sprints/releases" },
    ],
  },
  {
    icon: <TableIcon />,
...
const othersItems: NavItem[] = [
  {
    ...
    name: "Reports",
    subItems: [
      { name: "Dashboards", path: "/reports" },
      { name: "Custom Reports", path: "/reports/custom" },
      { name: "Earned Value", path: "/reports/earned-value" },
    ],
  },
  {
    icon: <PlugInIcon />,
    ...
    subItems: [
      ...
      { name: "Workload", path: "/resources/workload" },
      { name: "Skills Matrix", path: "/resources/skills" },
    ],
  },
];
